...
$xml_data_file = str_replace("eshop_brand_reference", 'citfact_brand_reference_delivery' . WIZARD_SITE_ID, file_get_contents($_SERVER["DOCUMENT_ROOT"] . $iblockXMLFile));
file_put_contents($_SERVER["DOCUMENT_ROOT"] . $iblockXMLFile, $xml_data_file );
