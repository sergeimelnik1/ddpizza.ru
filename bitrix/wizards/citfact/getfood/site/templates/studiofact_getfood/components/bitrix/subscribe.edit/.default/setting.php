...
<form action="<?=$arResult["FORM_ACTION"]?>" method="post" data-valid-form>
...
<tr valign="top">
	<td width="50%" style="padding-right: 20px;">
		...
		<input type="text" name="EMAIL" value="<?=$arResult["SUBSCRIPTION"]["EMAIL"]!=""?$arResult["SUBSCRIPTION"]["EMAIL"]:$arResult["REQUEST"]["EMAIL"];?>" size="30" maxlength="255" data-required="email"/></p><br />
