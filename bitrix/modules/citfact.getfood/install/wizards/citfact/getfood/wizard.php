...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	...
	{
		$wizard =& $this->GetWizard();
		$wizard->SetVar("templateID", "getfood_orange");
		$wizard->SetDefaultVar("wizTemplateID", "getfood_orange");
		$wizard->solutionName = "eshop";
		parent::InitStep();
		...
		$wizard->SetDefaultVars(
			Array(
				...
				"siteCopy" => $this->GetFileContent(WIZARD_SITE_PATH."include/copyright.php", GetMessage("WIZ_COMPANY_COPY_DEF") . "<br />" . GetMessage("WIZ_COMPANY_SCHEDULE_DEF")),
