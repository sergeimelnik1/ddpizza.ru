	...
	else
	{
		if($arResult["is_ajax_post"] != "Y" && $arResult["CanUserComment"])
		{
			...
			<div id="form_comment_" style="display:none;">
				...
				<form method="POST" name="form_comment" id="form_comment" action="<?=$ajaxPath; ?>" data-valid-form>
				...
				<div class="blog-comment-fields">
					...
					{
						?>
						<div class="blog-comment-field blog-comment-field-captcha clearfix">
							<div class="blog-comment-field-captcha-label">
								...
								<input type="text" size="30" name="captcha_word" id="captcha_word" value=""  tabindex="7" data-required>
								</div>
