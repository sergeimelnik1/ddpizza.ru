...
//*************************************
?>
<form action="<?=$arResult["FORM_ACTION"]?>" method="get" data-valid-form>
...
<tr valign="top">
	<td width="50%" style="padding-right: 20px;">
		...
		<input type="text" name="CONFIRM_CODE" value="<?echo $arResult["REQUEST"]["CONFIRM_CODE"];?>" size="20" data-required/></p>
