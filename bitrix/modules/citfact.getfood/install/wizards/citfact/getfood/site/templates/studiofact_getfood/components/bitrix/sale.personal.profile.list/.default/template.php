...
if (count($arResult["PROFILES"]))
{
	...
	<table class="table sale-personal-profile-list-container">
		...
		<?foreach($arResult["PROFILES"] as $val)
		{
			?>
			<tr>
				<td class="sale-personal-profile-list-30">
                    <div class="sale-personal-profile-list-mobile"><?=Loc::getMessage("P_"."ID")?></div>
                    <b><?= $val["ID"] ?></b>
                </td>
				<td class="sale-personal-profile-list-60">
                    <div class="sale-personal-profile-list-mobile"><?=Loc::getMessage("P_"."DATE_UPDATE")?></div>
                    <?= $val["DATE_UPDATE"] ?>
                </td>
				<td class="sale-personal-profile-list-30">
                    <div class="sale-personal-profile-list-mobile"><?=Loc::getMessage("P_"."NAME")?></div>
                    <?= $val["NAME"] ?>
                </td>
				<td class="sale-personal-profile-list-30">
                    <div class="sale-personal-profile-list-mobile"><?=Loc::getMessage("P_"."PERSON_TYPE_ID")?></div>
