				...
				foreach ($arResult["ITEMS"] as $arItem) {
					...
					?><div class="item_element good_box inline" id="<?=$strMainID;?>" data-id="<?=$arItem["ID"];?>">
						...
						<div class="hover_box box<? if ($can_buy != "1") { echo ' disabled'; } ?>">
							...
							?></div>
							<div class="img_box">
								<a href="javascript:;" data-fancybox="group6" data-src="<?=$arItem["DETAIL_PAGE_URL"];?>?open_popup=Y" class="zoom open_fancybox" rel="gallery"><span class="zoom__text"><?=GetMessage("STUDIOFACT_FAST_VIEW");?></span></a>
