...
<?if($arResult["ALLOW_ANONYMOUS"]=="Y" && $_REQUEST["authorize"]<>"YES" && $_REQUEST["register"]<>"YES"):?>
	...
	<tr valign="top">
		...
		<td width="50%" style="padding-left: 20px;"><p><?echo GetMessage("adm_reg_text")?></p></td>
	</tr>
	</table>
	<br />
		...
		<tr valign="top">
			<td width="50%" style="padding-right: 20px;">
				<form action="<?=$arResult["FORM_ACTION"]?>" method="post">
					...
					<input type="text" name="LOGIN" value="<?echo $arResult["REQUEST"]["LOGIN"]?>" size="20" data-required/></p>
					<p><?echo GetMessage("adm_auth_pass")?><span class="starrequired">*</span><br />
					<input type="password" name="PASSWORD" size="20" value="<?echo $arResult["REQUEST"]["PASSWORD"]?>" data-required/></p>
