...
<? } ?>
    <span class="mobile"><? if ($arResult["NUM_PRODUCTS"] > 0 || 1) { ?><span class="quant inline"><span><?=$arResult["NUM_PRODUCTS"];?></span></span><? } ?><span class="icon inline">0</span></span>
    <span class="desktop">
		<? if ($arResult["NUM_PRODUCTS"] > 0 || 1) { ?><span class="quant inline"><span><?=$arResult["NUM_PRODUCTS"];?></span></span><? } else { ?><span class="icon inline">0</span><? } ?>
        <span id="cart_heading_wrapper cart_heading_wrapper2" class="cart_heading_wrapper">
			
            <? if ($summ >= 0) { ?><span class="summ inline"><?=str_replace(GetMessage("STUDIOFACT_RUB"), "<span class=\"rub black\">".GetMessage("STUDIOFACT_R")."</span>", $summ);?></span><? } else { ?><span class="summ inline"></span><? } ?>
                ...
                <?foreach ($arResult['CATEGORIES']['READY'] as $arItem):?>
                    ...
                    <td class="small_basket_hover_name">
                        ...
                        <div class="props">
							...
							foreach ($arItem["CUSTOM_PROPS"] as $arValue)
                            {
	                            echo '<span>' . $arValue["NAME"] . ':</span> ' . $arValue["VALUE"] . '<br />';
                            }
                            ?>
