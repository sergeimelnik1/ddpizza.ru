	...
	<div class="row">
		<div class="col-sm-12">
			<div class="bx-original-item-container">
				...
				<?endif?>
				<div class="bx-added-item-table-cell-itemname"><?=$arResult["ELEMENT"]["NAME"]?></div>
		...
		<div class="col-sm-12">
			...
			<div class="col-sm-12 bx-constructor-container-res">
				<div class="bx-constructor-container-result">
                    <div class="uppercase-buy-container">
                        <span class=""><?=GetMessage("CATALOG_SET_SUM")?>:</span>
                    </div>
					<div class="economy_price_container">
						...
						<span class="bx-item-set-economy-price" data-role="set-diff-price">
							<?if ($arResult["SET_ITEMS"]["PRICE_DISCOUNT_DIFFERENCE"]) {
								echo GetMessage("CATALOG_SET_DISCOUNT_DIFF", array("#PRICE#" => $arResult["SET_ITEMS"]["PRICE_DISCOUNT_DIFFERENCE"]));
							}?>
						</span>
					</div>
					<span class="bx-item-set-current-price" data-role="set-price"><?=$arResult["SET_ITEMS"]["PRICE"]?></span>
					<span class="buy_btn_box">
						<a href="javascript:void(0)" data-role="set-buy-btn" class="buy_btn" title="<?=GetMessage("CATALOG_SET_BUY")?>"><?=GetMessage("CATALOG_SET_BUY")?></a>
					</span>
				</div>
			</div>
		</div>
				...
				>
					<div class="bx-catalog-set-item">
						...
						<div class="bx-catalog-set-item-add-btn">
							<? if ($arItem['CAN_BUY']) { ?>
								<a href="javascript:void(0)" data-role="set-add-btn" class="btn-sm"><?= GetMessage("CATALOG_SET_BUTTON_ADD") ?></a><?
							} else { ?>
