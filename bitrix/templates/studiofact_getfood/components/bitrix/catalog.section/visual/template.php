...
<div class="catalog_section">
	<div class="section clearfix bx_catalog_list_home bx_blue catalog_ajax_wrapper" data-entity="<?=$containerName?>">
			...
			foreach ($arResult['ITEM_ROWS'] as $rowData)
			{
				...
				foreach ($rowItems as $item)
				{
					if($item["IBLOCK_SECTION_ID"]!=$section && count($arElementSections)>1){
						?></div><div class="section_title" data-id="<?=$item["IBLOCK_SECTION_ID"]?>" id="<?=$arSections[$item["IBLOCK_SECTION_ID"]]["CODE"]?>"><?=$arSections[$item["IBLOCK_SECTION_ID"]]["NAME"]?></div><div class="section clearfix bx_catalog_list_home bx_blue catalog_ajax_wrapper"><?
