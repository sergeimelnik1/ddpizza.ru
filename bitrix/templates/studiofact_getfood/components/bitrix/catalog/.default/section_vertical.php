...
<div class="bx_catalog_section_box">
	<div class="bx_catalog_text">
		...
		<?//$APPLICATION->IncludeComponent('studiofact:catalog.section.panel', '.default', array());?>
	</div>
	...
	$intSectionID = $APPLICATION->IncludeComponent(
		...
		array(
			"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
			"IBLOCK_ID" => $arParams["IBLOCK_ID"],
			"ELEMENT_SORT_FIELD" => $GLOBALS['sort_by'],
			"ELEMENT_SORT_ORDER" => $GLOBALS['order_by'],
			...
			'IS_SECTION' => 'Y', // если в разделе нет товаров, то выведется сообщение об этом
