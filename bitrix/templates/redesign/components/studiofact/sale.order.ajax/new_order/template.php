...
<?
$arResult["JS_DATA"]["minOrderPrice"] = "500 руб";
$arResult["JS_DATA"]["MIN_ORDER_VAL"] = "1500";
if (strlen($request->get('ORDER_ID')) > 0) {
                    ...
                    <div id="bx-soa-order" class="row bx-<?= $arParams['TEMPLATE_THEME'] ?>" style="opacity: 0">
                        ...
                        <div class="col-sm-9 bx-soa">
                            <div id="bx-soa-main-notifications">
                                ...
                                <div class="clearfix clear cl clr"></div>
                            </div>
                            <div class="clearfix clear cl clr"></div>
                            <!--	AUTH BLOCK	-->
    ...
    <? endif ?>
                            ...
                            <div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
                                <div class="bx-soa-section-title-container">
                                    <h2 class="bx-soa-section-title col-sm-9">
                                        <span class="bx-soa-section-title-count"></span>Данные клиента
                                    </h2>
                                    <div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?= $arParams['MESS_EDIT'] ?></a></div>
                                </div>
    ...
    <?= GetMessage('MESS_TO_CATALOG') ?>
                                ...
                                <a href="javascript:void(0)" style="margin: 10px 0" class="pull-right btn btn-primary btn-lg hidden-xs" data-save-button="true">
    <?= $arParams['MESS_ORDER'] ?>
                                </a>
                            </div>
...
//print_arr($arResult["JS_DATA"]["FULL_ORDER"]);
                    ?>
                ...
                <script>
                    ...
                    $("#soa-property-8").val("<?= htmlspecialchars($arResult["JS_DATA"]["FULL_ORDER"]) ?>");
