...
<div class="tab-pane active" style="padding: 40px 0 0 0; margin-top: -70px;">
<?
if($arResult['HAS_MAIN_PRODUCTS'])
{
	...
	?>
	<? if(empty($arParams['HIDE_BLOCK_TITLE']) || $arParams['HIDE_BLOCK_TITLE'] !== 'Y'){ ?><div style="top: 25px;" class="gift_title"><? echo ($arParams['BLOCK_TITLE']? htmlspecialcharsbx($arParams['BLOCK_TITLE']) : GetMessage('SLB_TPL_TITLE_GIFT')) ?></div><? } ?>
	<?
