...
$MESS["CT_BCS_CATALOG_EMPTY_MESSAGE"] = "В данном разделе пока нет товаров.";
$MESS["CT_BCS_CATALOG_FILTER_EMPTY_MESSAGE"] = "Товыры не найдены. Попробуйте изменить условие фильтра.";
?>