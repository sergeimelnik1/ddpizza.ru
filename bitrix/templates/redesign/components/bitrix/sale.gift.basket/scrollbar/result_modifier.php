...
$arResult['MODULES'] = array('iblock' => 1, 'catalog' => 1, 'currency' => 1);
...
if (!empty($arResult['ITEMS']))
{
  ...
  foreach ($arResult['ITEMS'] as $key => $arItem)
  {
    ...
    if ($arItem["PREVIEW_PICTURE"]["ID"] > 0) {
      $file = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]["ID"], Array("width" => 323, "height" => 245), BX_RESIZE_IMAGE_EXACT, false);
      if (strlen($file["src"]) > 0) {
